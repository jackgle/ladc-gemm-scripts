...
if size(mat_C,2)>2
    if isempty(od)
        for i = 1:k
            scatter3(mat_c_norm(idx==i,1), mat_c_norm(idx==i,2), mat_c_norm(idx==i,3),100,'o','MarkerFaceColor',c(i,:),'MarkerEdgeColor',c(i,:),'MarkerEdgeAlpha',.7,'MarkerFaceAlpha',.7,'LineWidth',1);
        end
    else
        for i = 1:k-1
            scatter3(mat_c_norm(idx==i,1), mat_c_norm(idx==i,2), mat_c_norm(idx==i,3),100,'o','MarkerFaceColor',c(i,:),'MarkerEdgeColor',c(i,:),'MarkerEdgeAlpha',.7,'MarkerFaceAlpha',.7,'LineWidth',1);
    ...
    if isempty(od)
        for i = 1:k
            scatter(mat_c_norm(idx==i,1), mat_c_norm(idx==i,2),100,'o','MarkerFaceColor',c(i,:),'MarkerEdgeColor',c(i,:),'MarkerEdgeAlpha',.7,'MarkerFaceAlpha',.7,'LineWidth',1);
        end
    else
        for i = 1:k-1
            scatter(mat_c_norm(idx==i,1), mat_c_norm(idx==i,2),100,'o','MarkerFaceColor',c(i,:),'MarkerEdgeColor',c(i,:),'MarkerEdgeAlpha',.7,'MarkerFaceAlpha',.7,'LineWidth',1);
